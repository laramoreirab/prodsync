...
import { aplicarEscopoGestor, autorizarMaquinaParam, autorizarSetorParam } from '../middlewares/setorAccessMiddleware.js';
...
router.get('/maquinas/:id_maquina/ordens/:id_ordem', autorizarMaquinaParam('id_maquina'), OEEController.maquinaPorOP);
