    ...
    static async buscarPorId(req, res) {
        try {
            ...
            const dadosNormalizados = {
                ...
                id_ordemProducao: evento.id_ordemProducao,
                op_afetada: evento.ordem_producao?.codigo_lote ?? (evento.id_ordemProducao ? `OP #${evento.id_ordemProducao}` : null),
                codigo_lote: evento.ordem_producao?.codigo_lote ?? null,
                ordem_producao: evento.ordem_producao ?? null,
