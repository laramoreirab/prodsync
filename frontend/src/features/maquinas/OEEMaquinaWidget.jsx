...
export function OEEMaquinaWidget({ maquinaId }) {
  ...
  // Separação de lógica baseada nas configurações locais da máquina
  ...
  return (
    <div className="flex flex-col gap-6 w-full p-4 h-full justify-between">
      ...
      <div className="flex flex-row gap-6 w-full items-center flex-1 justify-center">
        ...
        {/* Gráfico Principal (OEE da Máquina) - Lado Esquerdo (w-1/2) */}
        {metricaOeeGeral && (
        ...
        {/* Sub-indicadores Lineares - Lado Direito (w-1/2) */}
          ...
          {metricasSecundarias.map(({ key, label, color }) => {
            ...
            return (
              <div key={key} className="space-y-1">
                ...
                {/* Barra de Progresso Customizada com Suporte a Dark Mode */}
