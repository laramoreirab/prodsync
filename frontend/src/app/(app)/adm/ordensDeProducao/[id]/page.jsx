...
export default function OPDetalhePage({ params }) {
  ...
  const dadosOP = [
    ...
    { id: 2, status: 'Setup', data: '06/01 (09:30 - 10:15)', duracao: '00:45', produzido: '10', refugo: '5', motivo: 'Manutenção corretiva' },
    { id: 3, status: 'Setup', data: '13/09 (10:15 - 10:35)', duracao: '00:20', produzido: '20', refugo: '1', motivo: 'Ajuste de parâmetros' },
    { id: 4, status: 'Parada', data: '30/09 (11:00 - 12:00)', duracao: '01:00', produzido: '5', refugo: '8', motivo: 'Refugo elevado devido a falta de aquecimento' },
    { id: 5, status: 'Setup', data: '28/03 (12:00 - 14:00)', duracao: '01:00', produzido: '6', refugo: '8', motivo: 'Retirada de amostras para o laboratório de qualidade' },
    { id: 6, status: 'Setup', data: '30/07 (17:00 - 18:00)', duracao: '01:30', produzido: '13', refugo: '6', motivo: 'Finalização de status' },
    { id: 7, status: 'Parada', data: '20/09 (16:00 - 19:00)', duracao: '01:00', produzido: '20', refugo: '5', motivo: 'Falta de material' },
    { id: 8, status: 'Parada', data: '20/09 (16:00 - 19:00)', duracao: '01:00', produzido: '20', refugo: '5', motivo: 'Boa qualidade' },
  ];
