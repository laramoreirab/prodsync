        ...
        <NotificationDropdown
          ...
          trigger={
            ...
            >
              ...
              <span className="text-xs font-semibold group-data-[state=collapsed]/sidebar:hidden group-data-[state=collapsed]/sidebar:group-hover/sidebar:inline">Notificacoes</span></div>
          }
        />
        <ProfileDropdown
          align="end"
