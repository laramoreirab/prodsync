...
const passos = [
  ...
  },
  {
    ...
    href: "/adm/maquinas",
    icon: Wrench,
    objetivo: "Cadastre as maquinas depois que setores e usuarios ja existem.",
    configurar: "Setor, operador responsavel, metas, capacidade e dados tecnicos.",
    motivo: "Eventos, producao, OEE, Andon e notificacoes dependem da maquina estar vinculada corretamente.",
  },
  {
    titulo: "5. Motivos e Histórico de Eventos",
    menu: "Historico de Eventos",
    ...
    motivo: "Paradas e setups exigem justificativa para manter indicadores e relatorios confiaveis.",
  },
  {
    ...
    objetivo: "Cadastre as OPs quando o chao de fabrica ja estiver estruturado.",
    configurar: "Lotes, metas, maquinas, operadores e acompanhamento da producao.",
    motivo: "As OPs usam maquinas e operadores existentes para consolidar producao e refugos.",
  },
  {
    ...
    href: "/adm/andon",
    icon: Factory,
    objetivo: "Use por último para monitorar o ambiente ja configurado.",
    configurar: "Paineis de acompanhamento, status das maquinas e indicadores em tempo real.",
    motivo: "O Andon fica util depois que maquinas, operadores, eventos e OPs estao alimentando dados.",
  },
];
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  Siga as dependências do sistema para evitar cadastros sem vinculo e indicadores incompletos.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="rounded-lg border border-slate-200 bg-white p-5">
                ...
                <div className="mt-5 space-y-4 text-sm text-slate-600">
                  ...
                  <div>
                    <p className="font-semibold text-[#23304c]">Regra de negocio</p>
                    <p>{passo.motivo}</p>
                  </div>
                </div>
