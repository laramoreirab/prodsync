...
const TableListagens = ({
  ...
  const barraSelecionados =
    enableSelection &&
    hasSelection &&
    (excluirLote || editarLote || solicitarJustificativa);
  ...
  return (
    <div className="w-full mb-5 bg-transparent">
            ...
            {solicitarJustificativa && (
              <Dialog>
                <DialogTrigger asChild>
                  <Button
                    variant="outline"
                    className="h-8 border-primary text-primary bg-transparent hover:bg-primary/10"
                  >
          ...
          <TableHeader className="bg-transparent">
            <TableRow className="font-semibold h-14 text-[#17233b] bg-transparent border-slate-200/40 hover:bg-transparent dark:border-[#1d2d49]/40 dark:text-[#e7eefc] dark:hover:bg-transparent">
              ...
              {columns.map((col) => (
                <TableHead
                  key={col.key}
                  className={`${col.className} bg-transparent`}
                >
                  {col.label}
                </TableHead>
              ))}
                  ...
                  <TableCell className="text-right bg-transparent">
                    <div className="flex justify-end">
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent
                          align="end"
                          className="max-w-62 w-auto font-semibold pr-2"
                        >
      ...
      <div className="mt-3 flex flex-col items-center gap-1.5 bg-transparent">
        ...
        >
          Página{" "}
          <span className="text-slate-700 dark:text-[#f4f8ff]">
            {currentPage}
          </span>{" "}
          de{" "}
          <span className="text-slate-700 dark:text-[#f4f8ff]">
