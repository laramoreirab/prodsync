...
const AboutUs = ({
  ...
  return (
    <section id="sobre-nos" className="lg:py-20 sm:py-16 py-8">
            ...
            {statisticsCounter?.map((value, index) => {
              return (
                <div
                  ...
                  <div
                    className="flex gap-0 sm:gap-2 text-6xl sm:text-7xl md:text-8xl lg:text-9xl font-medium">
