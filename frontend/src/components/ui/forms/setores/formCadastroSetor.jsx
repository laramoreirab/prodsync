            ...
            <form onSubmit={handleSubmit} className="px-8 pb-8 pt-4 flex flex-col gap-6">
                <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label className="block text-xl font-medium text-gray-700 dark:text-slate-300 mb-1">Nome do Setor</label>
                            <input
                                type="text"
                                value={nomeSetor}
                                onChange={(e) => setNomeSetor(e.target.value)}
                                placeholder="Usinagem Pesada"
                                className="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-gray-700 dark:text-white placeholder-gray-300 outline-none shadow-sm text-lg"
                            />
                        </div>
                        <div>
                            <label className="block text-xl font-medium text-gray-700 dark:text-slate-300 mb-1">Localizacao Fisica</label>
                            <input
                                type="text"
                                value={localizacao}
                ...
                <div>
                    ...
                    <p className="text-xl text-[#545454] font-medium dark:text-slate-300 mb-4">Vincule os equipamentos que operarao nesse setor.</p>
                ...
                <div>
                    ...
                    <p className="text-xl text-[#545454] font-medium dark:text-slate-300 mb-4">Adicione os colaboradores e defina suas responsabilidades.</p>

                    <div className="flex items-end gap-3 max-w-4xl">
                        <div className="flex-1">
                            <label className="block text-xl font-medium text-gray-700 dark:text-slate-300 mb-1">Selecione o Usuario</label>
                        ...
                        <div className="flex-1">
                            <label className="block text-xl font-medium text-gray-700 dark:text-slate-300 mb-1">Definir Funcao</label>
                            <div className="relative">
                                <select
